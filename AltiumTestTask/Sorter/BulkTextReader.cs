...
//         //TODO: ? pool of StreamReader / streamwriters
//         //TODO: ? test wheter the bufferedStream still efficient
...
// #warning experimenting with reading into memory 
//                 var memory = ArrayPool<char>.Shared.Rent(BufferSize);
//                 //var memoryLength1 = streamReader.Read(memory);
//                 var memoryLength2 = await streamReader.ReadAsync(memory, cancellationToken).ConfigureAwait(false);
//
//                 NewFunction();
//
//                 void NewFunction()
//                 {
//                     var bulkOfLinesSpan = memory.AsSpan();
//                     var lastLineEnd = bulkOfLinesSpan.LastIndexOf('\n');
//                     //TODO: trim /r
//                     if (lastLineEnd > 0)
//                     {
//                         var length = bulkOfLinesSpan.Length;
//                         var bulkOfLinesSpanToParse = bulkOfLinesSpan.Slice(0, lastLineEnd);
//                         var listOfLines = new List<Span<char>>();
//                         var startOfString = 0; 
//                         while (startOfString < lastLineEnd)
//                         {
//                             //TODO: check +-1 mistake
//                             var nextStartOfString = bulkOfLinesSpanToParse.IndexOf('\n');
//                             var newLine = bulkOfLinesSpan.Slice(startOfString, nextStartOfString - nextStartOfString);
//                             bulkOfLinesSpanToParse = bulkOfLinesSpan.Slice(startOfString, length - nextStartOfString);
//                             startOfString = nextStartOfString;
